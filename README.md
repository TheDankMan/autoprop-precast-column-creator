...
## Install
Install from Extension Warehouse, then in SketchUp:
Extension Manager → Install Extension… (RBZ) → Restart SketchUp

## Use
Extensions → AutoProp Precast Column Creator → New Column…
Set dimensions and options → click to place → use preview controls → Enter to commit.
